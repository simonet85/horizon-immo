    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-700 rounded-xl shadow-lg overflow-hidden">
        <div class="px-8 py-6 text-white">
            <div class="flex items-center">
                <div class="w-20 h-20 mr-6">
                    <?php if(Auth::user()->avatar): ?>
                        <img class="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg" 
                             src="<?php echo e(\Illuminate\Support\Facades\Storage::url(Auth::user()->avatar)); ?>" 
                ...
                <div class="flex-1">
                    <h1 class="text-3xl font-bold mb-2"><?php echo e(Auth::user()->name); ?></h1>
...
[$__name, $__params] = $__split('forms.update-avatar-form');

$__html = app('livewire')->mount($__name, $__params, 'lw-3644575929-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3644575929-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3644575929-2', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-100 border border-green-200 rounded-xl p-6">
                ...
                <div class="space-y-4">
                    <div class="bg-white rounded-lg p-4 shadow-sm">
                        <div class="text-2xl font-bold text-green-600"><?php echo e(Auth::user()->created_at->diffForHumans()); ?></div>
                    ...
                    <div class="bg-white rounded-lg p-4 shadow-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('client.dashboard')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                Voir mon espace →
                            </a>
                        </div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center justify-between bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
                    ...
                    <?php if(Auth::user()->hasRole('admin')): ?>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center justify-between bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3644575929-3', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\profile-admin.blade.php ENDPATH**/ ?>