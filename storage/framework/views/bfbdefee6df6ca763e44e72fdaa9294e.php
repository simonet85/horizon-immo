...
<?php $__env->startSection('title', 'Gestion du Contenu Site'); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="border-b border-gray-200 mb-6" x-data="{ activeTab: 'hero' }">
            ...
            <div x-show="activeTab === 'hero'" class="mt-6">
                ...
                <form action="<?php echo e(route('admin.home-content.update-hero')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="title" name="title" 
                                   value="<?php echo e($hero['titre_principal']->value ?? 'Votre Rêve Immobilier en Afrique du Sud'); ?>"
                        ...
                        <div>
                            ...
                            <textarea id="subtitle" name="subtitle" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e($hero['sous_titre']->value ?? 'Courtage, accompagnement financier et conseils personnalisés pour votre acquisition immobilière en toute sérénité'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="button_1_text" name="button_1_text" 
                                   value="<?php echo e($hero['bouton_principal_text']->value ?? 'Découvrir nos Biens'); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="button_1_url" name="button_1_url" 
                                   value="<?php echo e($hero['bouton_principal_url']->value ?? '/catalogue'); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="button_2_text" name="button_2_text" 
                                   value="<?php echo e($hero['bouton_secondaire_text']->value ?? 'Accompagnement Financier'); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="button_2_url" name="button_2_url" 
                                   value="<?php echo e($hero['bouton_secondaire_url']->value ?? '/accompagnement'); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="mt-6">
                        ...
                        <?php if(isset($hero['background_image']) && $hero['background_image']->image_path): ?>
                            <div class="mb-4">
                                <p class="text-sm text-gray-600 mb-2">Image actuelle :</p>
                                <img src="<?php echo e(asset('storage/' . $hero['background_image']->image_path)); ?>" 
            ...
            <div x-show="activeTab === 'navigation'" class="mt-6">
                ...
                <form action="<?php echo e(route('admin.home-content.update-logo')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    ...
                    <div>
                        ...
                        <?php if(isset($navigation['logo']) && $navigation['logo']->image_path): ?>
                            <div class="mb-4">
                                <p class="text-sm text-gray-600 mb-2">Logo actuel :</p>
                                <img src="<?php echo e(asset('storage/' . $navigation['logo']->image_path)); ?>" 
                                     alt="Logo actuel" 
            ...
            <div x-show="activeTab === 'services'" class="mt-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('admin.services.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                        Ajouter un service
                    </a>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="font-semibold text-gray-900"><?php echo e($service->title); ?></h4>
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('admin.services.edit', $service)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">Éditer</a>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e(Str::limit($service->description, 100)); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-3 text-center py-8">
                            <p class="text-gray-500">Aucun service configuré</p>
                            <a href="<?php echo e(route('admin.services.create')); ?>" class="text-blue-600 hover:text-blue-800">Créer le premier service</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'testimonials'" class="mt-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-start mb-3">
                                <?php if($testimonial->client_photo): ?>
                                    <img src="<?php echo e(asset('storage/' . $testimonial->client_photo)); ?>" alt="<?php echo e($testimonial->client_name); ?>" class="w-12 h-12 rounded-full mr-3">
                                <?php else: ?>
                                    <div class="w-12 h-12 bg-gray-300 rounded-full mr-3 flex items-center justify-center">
                                        <span class="text-gray-600 text-lg"><?php echo e(substr($testimonial->client_name, 0, 1)); ?></span>
                                    </div>
                                <?php endif; ?>
                                <div>
                                    <h4 class="font-semibold"><?php echo e($testimonial->client_name); ?></h4>
                                    <?php if($testimonial->client_title): ?>
                                        <p class="text-sm text-gray-600"><?php echo e($testimonial->client_title); ?></p>
                                    <?php endif; ?>
                            ...
                            <p class="text-sm text-gray-700 mb-3"><?php echo e(Str::limit($testimonial->testimonial, 150)); ?></p>
                            <div class="flex justify-end space-x-2">
                                <a href="<?php echo e(route('admin.testimonials.edit', $testimonial)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                    Modifier
                                </a>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-2 text-center py-8 text-gray-500">
                            Aucun témoignage configuré. <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="text-blue-600">Ajouter le premier témoignage</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'process'" class="mt-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('admin.process-steps.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                        Ajouter une étape
                    </a>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $processSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border border-gray-200 rounded-lg p-4 text-center">
                            <div class="w-16 h-16 bg-blue-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                                <?php if($step->icon): ?>
                                    <img src="<?php echo e(asset('storage/' . $step->icon)); ?>" alt="<?php echo e($step->title); ?>" class="w-10 h-10">
                                <?php else: ?>
                            ...
                            <h4 class="font-semibold mb-2"><?php echo e($step->title); ?></h4>
                            <p class="text-sm text-gray-600 mb-4"><?php echo e(Str::limit($step->description, 100)); ?></p>
                            <div class="flex justify-center space-x-2">
                                <a href="<?php echo e(route('admin.process-steps.edit', $step)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                    Modifier
                                </a>
                                <form action="<?php echo e(route('admin.process-steps.destroy', $step)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm" 
                                            onclick="return confirm('Êtes-vous sûr ?')">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-3 text-center py-8 text-gray-500">
                            Aucune étape configurée. <a href="<?php echo e(route('admin.process-steps.create')); ?>" class="text-blue-600">Ajouter la première étape</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'partners'" class="mt-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="<?php echo e(route('admin.partners.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border border-gray-200 rounded-lg p-4 text-center">
                            <div class="w-24 h-16 mx-auto mb-4 bg-gray-100 rounded flex items-center justify-center">
                                ...
                                <?php else: ?>
                                    <span class="text-gray-400"><?php echo e(substr($partner->name, 0, 2)); ?></span>
                                <?php endif; ?>
                            </div>
                            <h4 class="font-semibold mb-2"><?php echo e($partner->name); ?></h4>
                            <?php if($partner->description): ?>
                                <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($partner->description, 80)); ?></p>
                            <?php endif; ?>
                            <?php if($partner->website_url): ?>
                                <a href="<?php echo e($partner->website_url); ?>" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm block mb-2">
                                    Visiter le site
                                </a>
                            <?php endif; ?>
                            <div class="flex justify-center space-x-2">
                                <a href="<?php echo e(route('admin.partners.edit', $partner)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                                    Modifier
                                </a>
                                <form action="<?php echo e(route('admin.partners.destroy', $partner)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-800 text-sm" 
                                            onclick="return confirm('Êtes-vous sûr ?')">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-4 text-center py-8 text-gray-500">
                            Aucun partenaire configuré. <a href="<?php echo e(route('admin.partners.create')); ?>" class="text-blue-600">Ajouter le premier partenaire</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'cta'" class="mt-6">
                ...
                <form action="<?php echo e(route('admin.home-content.update-cta')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" name="title" class="w-full px-3 py-2 border border-gray-300 rounded-md" 
                                   value="<?php echo e($cta?->title ?? 'Prêt à Concrétiser Votre Projet ?'); ?>" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                            <textarea name="description" class="w-full px-3 py-2 border border-gray-300 rounded-md" rows="3" required><?php echo e($cta?->description ?? 'Profitez de notre expertise pour acquérir le bien de vos rêves en Afrique du Sud. Consultation gratuite et sans engagement.'); ?></textarea>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="button_1_text" class="w-full px-3 py-2 border border-gray-300 rounded-md" 
                                       value="<?php echo e($cta?->button_1_text ?? 'Demander un Accompagnement'); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="button_1_url" class="w-full px-3 py-2 border border-gray-300 rounded-md" 
                                       value="<?php echo e($cta?->button_1_url ?? '/accompagnement'); ?>" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="button_2_text" class="w-full px-3 py-2 border border-gray-300 rounded-md" 
                                       value="<?php echo e($cta?->button_2_text ?? 'Nous Contacter'); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="button_2_url" class="w-full px-3 py-2 border border-gray-300 rounded-md" 
                                       value="<?php echo e($cta?->button_2_url ?? '/contact'); ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mt-6">
            ...
            <div x-show="activeTab === 'contact'" class="mt-6" x-data="{ contactTab: 'header' }">
                ...
                <div x-show="contactTab === 'header'">
                    <form action="<?php echo e(route('admin.home-content.update-contact-header')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="title" id="contact_title" 
                                       ...
                                       value="<?php echo e($contactHeader['title'] ?? 'Contactez-Nous'); ?>" required>
                            </div>
                            <div>
                                ...
                                <textarea name="description" id="contact_description" rows="3"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required><?php echo e($contactHeader['description'] ?? ''); ?></textarea>
                            </div>
                        </div>
                ...
                <div x-show="contactTab === 'form'">
                    <form action="<?php echo e(route('admin.home-content.update-contact-form')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="section_title" id="form_section_title" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['section_title'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="subtitle" id="form_subtitle" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['subtitle'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="label_prenom" id="label_prenom" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['label_prenom'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="label_nom" id="label_nom" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['label_nom'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="label_email" id="label_email" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['label_email'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="label_telephone" id="label_telephone" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['label_telephone'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="label_sujet" id="label_sujet" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactForm['label_sujet'] ?? ''); ?>" required>
                            </div>
                            <div>
                ...
                <div x-show="contactTab === 'info'">
                    <form action="<?php echo e(route('admin.home-content.update-contact-info')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="section_title" id="info_section_title" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['section_title'] ?? ''); ?>" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_label" id="phone_label" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['phone_label'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="phone_france" id="phone_france" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['phone_france'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="phone_south_africa" id="phone_south_africa" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['phone_south_africa'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="email_label" id="email_label" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['email_label'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="email" name="email_contact" id="email_contact" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['email_contact'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="email" name="email_rh" id="email_rh" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['email_rh'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="hours_label" id="hours_label" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['hours_label'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="hours_weekdays" id="hours_weekdays" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['hours_weekdays'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="hours_saturday" id="hours_saturday" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['hours_saturday'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="hours_sunday" id="hours_sunday" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactInfo['hours_sunday'] ?? ''); ?>" required>
                            </div>
                        </div>
                ...
                <div x-show="contactTab === 'why_choose'">
                    <form action="<?php echo e(route('admin.home-content.update-contact-why-choose')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="section_title" id="why_section_title" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactWhyChoose['section_title'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="advantage_1" id="advantage_1" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactWhyChoose['advantage_1'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="advantage_2" id="advantage_2" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactWhyChoose['advantage_2'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="advantage_3" id="advantage_3" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactWhyChoose['advantage_3'] ?? ''); ?>" required>
                            </div>
                        </div>
                ...
                <div x-show="contactTab === 'partner'">
                    <form action="<?php echo e(route('admin.home-content.update-contact-partner')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" name="title" id="partner_title" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactPartner['title'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="partner_name" id="partner_name" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactPartner['partner_name'] ?? ''); ?>" required>
                            </div>
                            <div>
                                ...
                                <input type="text" name="description" id="partner_description" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                       value="<?php echo e($contactPartner['description'] ?? ''); ?>" required>
                            </div>
                        </div>
            ...
            <div x-show="activeTab === 'footer'" class="mt-6" x-data="{ footerTab: 'company' }">
                ...
                <div x-show="footerTab === 'company'">
                    <form action="<?php echo e(route('admin.home-content.update-footer-company')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="company_name" 
                                       value="<?php echo e($footerCompany['company_name'] ?? 'Immobilier SA'); ?>"
                            ...
                            <div>
                                ...
                                <textarea name="company_description" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md" required><?php echo e($footerCompany['company_description'] ?? 'Votre partenaire de confiance pour investir dans l\'immobilier sud-africain. Expertise, accompagnement personnalisé et financement sécurisé.'); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="certification_1" 
                                       value="<?php echo e($footerCompany['certification_1'] ?? 'Certifié & Assuré'); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="certification_2" 
                                       value="<?php echo e($footerCompany['certification_2'] ?? 'Expert Agréé'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md">
                            </div>
                        </div>
                ...
                <div x-show="footerTab === 'contact'">
                    <form action="<?php echo e(route('admin.home-content.update-footer-contact')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" 
                                       value="<?php echo e($footerContact['email'] ?? 'contact@immobilier-sa.com'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_france" 
                                       value="<?php echo e($footerContact['phone_france'] ?? '+33 1 XX XX XX XX'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="phone_south_africa" 
                                       value="<?php echo e($footerContact['phone_south_africa'] ?? '+27 XXXX XX XXXX (Afrique du Sud)'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="address" 
                                       value="<?php echo e($footerContact['address'] ?? 'Bureau France & Afrique du Sud - Sur rendez-vous uniquement'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="hours_weekdays" 
                                       value="<?php echo e($footerContact['hours_weekdays'] ?? 'Lun - Ven: 9h - 18h'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="hours_saturday" 
                                       value="<?php echo e($footerContact['hours_saturday'] ?? 'Sam: 9h - 13h'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="hours_sunday" 
                                       value="<?php echo e($footerContact['hours_sunday'] ?? 'Dim: Sur rendez-vous'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
                ...
                <div x-show="footerTab === 'legal'">
                    <form action="<?php echo e(route('admin.home-content.update-footer-legal')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="copyright_year" 
                                       value="<?php echo e($footerLegal['copyright_year'] ?? '2024'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="company_legal_name" 
                                       value="<?php echo e($footerLegal['company_legal_name'] ?? 'Immobilier SA. Tous droits réservés.'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="partner_name" 
                                       value="<?php echo e($footerLegal['partner_name'] ?? 'Standard Bank'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="partner_description" 
                                       value="<?php echo e($footerLegal['partner_description'] ?? 'Solutions de financement privilégiées'); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md" required>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\admin\home-content\index.blade.php ENDPATH**/ ?>