...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Bienvenue <?php echo e(Auth::user()->name); ?>, gérez vos demandes et messages</p>
            </div>
            <div class="text-right">
                <p class="text-sm text-gray-500">Membre depuis</p>
                <p class="text-lg font-semibold text-gray-900"><?php echo e(Auth::user()->created_at->format('M Y')); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_applications']); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['approved_applications']); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_messages']); ?></p>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="<?php echo e(route('accompagnement')); ?>" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
            ...
            <a href="<?php echo e(route('catalogue')); ?>" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('client.applications.index')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Voir tout
                </a>
            </div>
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $recentApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="ml-3 flex-1">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($application->accompany_type); ?></p>
                            <p class="text-sm text-gray-500">Budget: <?php echo e($application->budget_range); ?></p>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-6">
                        ...
                        <a href="<?php echo e(route('accompagnement')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium mt-1 inline-block">
                            Créer une demande
                        </a>
                    </div>
                <?php endif; ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Nouveau message
                </a>
            </div>
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="ml-3 flex-1">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($message->subject ?? 'Message'); ?></p>
                        ...
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                <?php echo e($message->status === 'unread' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'); ?>">
                                <?php echo e($message->status === 'unread' ? 'Nouveau' : 'Lu'); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-6">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium mt-1 inline-block">
                            Envoyer un message
                        </a>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\client\dashboard.blade.php ENDPATH**/ ?>