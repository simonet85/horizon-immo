    ...
    <section class="bg-blue-900 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl md:text-2xl max-w-3xl mx-auto">
                Étape <?php echo e($currentStep); ?> sur <?php echo e($totalSteps); ?>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center <?php echo e($i < $totalSteps ? 'flex-1' : ''); ?>">
                    <div class="flex items-center justify-center w-8 h-8 rounded-full <?php echo e($currentStep >= $i ? 'bg-blue-600 text-white' : 'bg-gray-300 text-gray-600'); ?>">
                        <?php echo e($i); ?>

                    </div>
                    <?php if($i < $totalSteps): ?>
                    <div class="flex-1 h-1 mx-4 <?php echo e($currentStep > $i ? 'bg-blue-600' : 'bg-gray-300'); ?>"></div>
                    <?php endif; ?>
                </div>
                <?php endfor; ?>
            </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg p-8">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($this->stepTitle); ?></h2>
                    <p class="text-gray-600"><?php echo e($this->stepDescription); ?></p>
                </div>

                <form wire:submit="<?php echo e($currentStep == $totalSteps ? 'submitRequest' : 'nextStep'); ?>">
                    <?php if($currentStep == 1): ?>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label for="personal_contribution" class="block text-sm font-medium text-gray-700 mb-4">
                                        Apport personnel: <span class="text-lg font-bold text-blue-600"><?php echo e($personal_contribution_percentage); ?>%</span>
                                    </label>
                                    <div class="px-3">
                                ...
                                <div>
                                    <label for="loan_duration" class="block text-sm font-medium text-gray-700 mb-2">
                                        Durée du prêt: <span class="font-semibold"><?php echo e($loan_duration); ?> ans</span>
                                    </label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-semibold text-gray-900"><?php echo e($interest_rate); ?>%</span>
                                    </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-white border-2 border-blue-200 rounded-xl p-6">
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-bold text-lg"><?php echo e(number_format($this->averageBudget, 0, ',', ' ')); ?> ZAR</span>
                                        </div>
                                        
                                        <div class="flex justify-between items-center">
                                            <span class="text-gray-600">Apport personnel (<?php echo e($personal_contribution_percentage); ?>%):</span>
                                            <span class="font-bold text-green-600"><?php echo e(number_format($this->personalContributionAmount, 0, ',', ' ')); ?> ZAR</span>
                                        </div>
                                        
                                        <div class="flex justify-between items-center">
                                            <span class="text-gray-600">Montant à financer:</span>
                                            <span class="font-bold text-blue-600"><?php echo e(number_format($this->loanAmount, 0, ',', ' ')); ?> ZAR</span>
                                        </div>
                                        
                                        <div class="border-t pt-4">
                                            <div class="flex justify-between items-center">
                                                <span class="text-gray-600">Mensualité estimée:</span>
                                                <span class="font-bold text-xl text-indigo-600"><?php echo e(number_format($this->monthlyPayment, 0, ',', ' ')); ?> ZAR/mois</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if($monthly_income): ?>
                                <div class="bg-<?php echo e($this->affordabilityStatus['color']); ?>-50 border border-<?php echo e($this->affordabilityStatus['color']); ?>-200 rounded-xl p-6">
                                    <h4 class="font-semibold text-<?php echo e($this->affordabilityStatus['color']); ?>-900 mb-3 flex items-center">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-bold text-<?php echo e($this->affordabilityStatus['color']); ?>-700"><?php echo e(number_format($this->affordabilityRatio, 1)); ?>%</span>
                                        </div>
                                        
                                        <div class="w-full bg-gray-200 rounded-full h-3">
                                            <div class="bg-<?php echo e($this->affordabilityStatus['color']); ?>-500 h-3 rounded-full transition-all duration-300" 
                                                 style="width: <?php echo e(min($this->affordabilityRatio, 100)); ?>%"></div>
                                        </div>
                                        
                                        <p class="text-sm text-<?php echo e($this->affordabilityStatus['color']); ?>-700 font-medium">
                                            <?php echo e($this->affordabilityStatus['message']); ?>

                                        </p>
                                        
                                        <?php if($this->affordabilityRatio > 50): ?>
                        ...
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <?php if($personal_contribution_percentage < 20): ?>
...
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\accompaniment-form.blade.php ENDPATH**/ ?>