...
<?php $__env->startSection('title', 'Message de contact'); ?>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="border-b border-gray-200 pb-6 mb-6">
                        <div class="flex justify-between items-start">
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900"><?php echo e($contactMessage->subject); ?></h1>
                                <p class="text-gray-600 mt-1">Envoyé le <?php echo e($contactMessage->created_at->format('d/m/Y à H:i')); ?></p>
                            </div>
                    ...
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900"><?php echo e($contactMessage->email); ?></p>
                            </div>
                            <?php if($contactMessage->phone): ?>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Téléphone</label>
                                    <p class="mt-1 text-sm text-gray-900"><?php echo e($contactMessage->phone); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\client\messages\show-contact.blade.php ENDPATH**/ ?>