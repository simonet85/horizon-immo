                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button wire:click="setSortBy('price')" 
                                class="px-3 py-1 rounded-lg text-sm transition-colors <?php echo e($sortBy === 'price' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>"
                                type="button">
                            Prix
                            <?php if($sortBy === 'price'): ?>
                                <span class="ml-1"><?php if($sortDirection === 'asc'): ?> ↑ <?php else: ?> ↓ <?php endif; ?></span>
                            <?php endif; ?>
                        </button>
                        <button wire:click="setSortBy('created_at')" 
                                class="px-3 py-1 rounded-lg text-sm transition-colors <?php echo e($sortBy === 'created_at' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>"
                                type="button">
                            Date
                        ...
                        <button wire:click="setSortBy('title')" 
                                class="px-3 py-1 rounded-lg text-sm transition-colors <?php echo e($sortBy === 'title' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>"
                                type="button">
                            Nom
                            <?php if($sortBy === 'title'): ?>
                                <span class="ml-1"><?php if($sortDirection === 'asc'): ?> ↑ <?php else: ?> ↓ <?php endif; ?></span>
                    ...
                    <!-- Results count -->
                    <div class="ml-auto">
                        <span class="text-sm text-gray-600"><?php echo e($properties->total()); ?> propriété(s) trouvée(s)</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="relative">
                        <img src="<?php echo e($property->main_image); ?>" alt="<?php echo e($property->title); ?>" class="w-full h-64 object-cover">
                        <div class="absolute top-4 left-4">
                            ...
                            <?php else: ?>
                                <span class="bg-gray-500 text-white px-3 py-1 rounded-full text-sm font-medium"><?php echo e(ucfirst($property->status)); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="absolute top-4 right-4">
                            <span class="bg-white text-gray-900 px-3 py-1 rounded-full text-sm font-bold"><?php echo e($property->formatted_price); ?></span>
                        </div>
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-2"><?php echo e($property->title); ?></h3>
                        ...
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e(Str::limit($property->description, 100)); ?></p>
                        ...
                        <div class="flex justify-between text-sm text-gray-500 mb-4">
                            ...
                            <span class="flex items-center">
                                ...
                                <?php echo e($property->bathrooms); ?> sdb
                            </span>
                            <?php endif; ?>
                            ...
                            <span class="flex items-center">
                                ...
                                <?php echo e(number_format($property->surface_area, 0)); ?> m²
                            </span>
                            <?php endif; ?>
                        </div>
                        
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-blue-600 font-medium bg-blue-50 px-3 py-1 rounded-full"><?php echo e($property->type); ?></span>
                            <div class="flex space-x-2">
                                ...
                                <a href="<?php echo e(route('property.detail', $property->id)); ?>" class="btn-primary text-sm py-2 px-3">
                                    Détails
                                </a>
                                <a href="/contact?property=<?php echo e($property->id); ?>" class="btn-primary text-sm py-2 px-3">
                                    Question
                                </a>
                            </div>
                        </div>
...
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\catalog-page.blade.php ENDPATH**/ ?>