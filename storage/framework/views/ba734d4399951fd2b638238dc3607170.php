...
<?php $__env->startSection('title', isset($testimonial) ? 'Modifier le Témoignage' : 'Nouveau Témoignage'); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mt-4">
                <?php echo e(isset($testimonial) ? 'Modifier le Témoignage' : 'Nouveau Témoignage'); ?>

            </h2>
        </div>

        <form action="<?php echo e(isset($testimonial) ? route('admin.testimonials.update', $testimonial) : route('admin.testimonials.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="client_title" 
                           name="client_title" 
                           value="<?php echo e(old('client_title', $testimonial->client_title ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="property_type" 
                           name="property_type" 
                           value="<?php echo e(old('property_type', $testimonial->property_type ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    <?php if(isset($testimonial) && $testimonial->client_photo): ?>
                        <div class="mt-2">
                            <img src="<?php echo e(asset('storage/' . $testimonial->client_photo)); ?>" alt="Photo actuelle" class="w-16 h-16 rounded-full object-cover">
            ...
            <div class="mt-6">
                ...
                <textarea id="testimonial" 
                          ...
                          rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          required><?php echo e(old('testimonial', $testimonial->testimonial ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-start p-4 border border-gray-200 rounded-lg bg-white">
                    <div class="w-12 h-12 bg-gray-300 rounded-full mr-4 flex items-center justify-center">
                        <span id="preview-initial" class="text-gray-600 text-lg"><?php echo e(substr(old('client_name', $testimonial->client_name ?? 'C'), 0, 1)); ?></span>
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center mb-2">
                            <div>
                                <h4 id="preview-name" class="font-semibold text-gray-900"><?php echo e(old('client_name', $testimonial->client_name ?? 'Nom du client')); ?></h4>
                                <p id="preview-title" class="text-sm text-gray-600"><?php echo e(old('client_title', $testimonial->client_title ?? '')); ?></p>
                            </div>
                            <div id="preview-stars" class="ml-auto flex items-center">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <svg class="w-4 h-4 star <?php echo e($i <= (old('rating', $testimonial->rating ?? 5)) ? 'text-yellow-400' : 'text-gray-300'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                <?php endfor; ?>
                            </div>
                        </div>
                        <p id="preview-testimonial" class="text-sm text-gray-700"><?php echo e(old('testimonial', $testimonial->testimonial ?? 'Le témoignage apparaîtra ici...')); ?></p>
                        <p id="preview-property" class="text-xs text-gray-500 mt-2">Type de bien : <?php echo e(old('property_type', $testimonial->property_type ?? 'Non spécifié')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4 mt-8">
                ...
                <button type="submit" 
                    ...
                    <?php echo e(isset($testimonial) ? 'Mettre à jour' : 'Créer'); ?> le témoignage
                </button>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\admin\testimonials\create.blade.php ENDPATH**/ ?>