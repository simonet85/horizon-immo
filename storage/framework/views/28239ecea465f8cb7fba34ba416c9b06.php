        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="text" 
                    name="name"
                    class="block w-full pl-12 pr-4 py-4 border <?php echo e($errors->get('name') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'); ?> rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" 
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="email" 
                    name="email"
                    class="block w-full pl-12 pr-12 py-4 border <?php echo e($errors->get('email') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'); ?> rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" 
                    placeholder="votre.email@exemple.com"
                    required 
                    autocomplete="username" 
                />
                <?php if(!$errors->get('email') && $email && filter_var($email, FILTER_VALIDATE_EMAIL)): ?>
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="password" 
                    name="password"
                    class="block w-full pl-12 pr-12 py-4 border <?php echo e($errors->get('password') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'); ?> rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" 
                    placeholder="••••••••••••"
                    required 
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    class="block w-full pl-12 pr-12 py-4 border <?php echo e($errors->get('password_confirmation') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'); ?> rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" 
                    placeholder="••••••••••••"
                    required 
                    autocomplete="new-password" 
                />
...
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\pages\auth\register.blade.php ENDPATH**/ ?>