                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <ul class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="px-6 py-4 hover:bg-gray-50 <?php echo e(!$message->is_read ? 'bg-blue-50' : ''); ?>">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="ml-4 flex items-center space-x-2">
                                        ...
                                        <form action="<?php echo e(route('admin.messages.destroy', $message)); ?>" 
                                              method="POST" 
                                              class="inline">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\admin\messages\index.blade.php ENDPATH**/ ?>