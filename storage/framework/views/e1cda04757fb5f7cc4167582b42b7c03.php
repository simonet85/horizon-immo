        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-800">
                    <strong>Email à vérifier:</strong> <?php echo e(Auth::user()->email ?? 'votre@email.com'); ?>
...
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\pages\auth\verify-email.blade.php ENDPATH**/ ?>