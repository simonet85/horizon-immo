...
<div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <span class="text-sm text-gray-500">
                    <?php echo e($messages->total()); ?> messages au total
                </span>
            </div>
        </div>
    </div>
    ...
    <!-- Filtres et actions -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form method="POST" action="<?php echo e(route('admin.contact-messages.bulk-action')); ?>" id="bulkForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-start p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <input type="checkbox" name="messages[]" value="<?php echo e($message->id); ?>" 
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex items-center space-x-1">
                                        ...
                                        <?php if($message->status === 'unread'): ?>
                                            <a href="<?php echo e(route('admin.contact-messages.mark-read', $message)); ?>" 
                                               class="text-green-600 hover:text-green-800 text-sm">
                                                Marquer lu
                                            </a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('admin.contact-messages.mark-unread', $message)); ?>" 
                            ...
                            <div class="mt-1">
                                <p class="text-sm text-gray-600">
                                    ...
                                    <?php if($message->phone): ?>
                                        | <strong>Téléphone:</strong> <?php echo e($message->phone); ?>

                                    <?php endif; ?>
                                </p>
                                <p class="text-sm text-gray-600 mt-1">
                                    <strong>Sujet:</strong> <?php echo e($message->subject); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\admin\contact-messages\index.blade.php ENDPATH**/ ?>