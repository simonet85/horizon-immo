                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            <div class="flex items-start space-x-4">
                                <?php if($property->images && count($property->images) > 0): ?>
                                    <img src="<?php echo e($property->images[0]); ?>" alt="<?php echo e($property->title); ?>" class="w-16 h-16 rounded-lg object-cover">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-900"><?php echo e($property->title); ?></h3>
                                    <p class="text-sm text-gray-600"><?php echo e($property->city); ?> • <?php echo e($property->formatted_price); ?></p>
                                    <a href="<?php echo e(route('property.detail', $property->id)); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('hideSuccess', () => {
                setTimeout(() => {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').showSuccess = false;
                }, 5000);
            });
        });
    </script>
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\contact-page.blade.php ENDPATH**/ ?>