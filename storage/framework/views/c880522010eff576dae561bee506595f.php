    ...
    <div class="flex items-center space-x-6 mb-6">
        <div class="shrink-0">
            <?php if(Auth::user()->avatar): ?>
                <img class="h-20 w-20 rounded-full object-cover" 
                     src="<?php echo e(Storage::url(Auth::user()->avatar)); ?>" 
                     alt="Avatar actuel">
            <?php else: ?>
        ...
        <div>
            <p class="text-sm text-gray-600">
                <?php echo e(Auth::user()->avatar ? 'Votre photo de profil actuelle' : 'Vous n\'avez pas encore de photo de profil'); ?>
...
</script><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\forms\update-avatar-form.blade.php ENDPATH**/ ?>