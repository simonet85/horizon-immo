        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-800">
                    <strong>Connecté en tant que:</strong> <?php echo e(Auth::user()->email ?? 'Utilisateur'); ?>
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="password" 
                    name="password"
                    class="block w-full pl-12 pr-12 py-4 border <?php echo e($errors->get('password') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'); ?> rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200" 
...
</div><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\livewire\pages\auth\confirm-password.blade.php ENDPATH**/ ?>