...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <form action="<?php echo e(route('client.applications.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="<?php echo e(old('country_residence')); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   id="desired_city" 
                                   name="desired_city" 
                                   value="<?php echo e(old('desired_city')); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="property_type" 
                                ...
                                <option value="Maison" <?php echo e(old('property_type') == 'Maison' ? 'selected' : ''); ?>>Maison</option>
                                <option value="Villa" <?php echo e(old('property_type') == 'Villa' ? 'selected' : ''); ?>>Villa</option>
                                <option value="Studio" <?php echo e(old('property_type') == 'Studio' ? 'selected' : ''); ?>>Studio</option>
                                <option value="Loft" <?php echo e(old('property_type') == 'Loft' ? 'selected' : ''); ?>>Loft</option>
                                <option value="Duplex" <?php echo e(old('property_type') == 'Duplex' ? 'selected' : ''); ?>>Duplex</option>
                                <option value="Autre" <?php echo e(old('property_type') == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="budget_range" 
                                ...
                                <option value="Moins de 100 000€" <?php echo e(old('budget_range') == 'Moins de 100 000€' ? 'selected' : ''); ?>>Moins de 100 000€</option>
                                <option value="100 000€ - 200 000€" <?php echo e(old('budget_range') == '100 000€ - 200 000€' ? 'selected' : ''); ?>>100 000€ - 200 000€</option>
                                <option value="200 000€ - 300 000€" <?php echo e(old('budget_range') == '200 000€ - 300 000€' ? 'selected' : ''); ?>>200 000€ - 300 000€</option>
                                <option value="300 000€ - 500 000€" <?php echo e(old('budget_range') == '300 000€ - 500 000€' ? 'selected' : ''); ?>>300 000€ - 500 000€</option>
                                <option value="500 000€ - 1 000 000€" <?php echo e(old('budget_range') == '500 000€ - 1 000 000€' ? 'selected' : ''); ?>>500 000€ - 1 000 000€</option>
                                <option value="Plus de 1 000 000€" <?php echo e(old('budget_range') == 'Plus de 1 000 000€' ? 'selected' : ''); ?>>Plus de 1 000 000€</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e(old('personal_contribution_percentage')); ?>"
                                   min="0" 
                                   max="100"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="additional_info" 
                                      ...
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                      placeholder="Ajoutez toute information que vous jugez utile pour votre projet..."><?php echo e(old('additional_info')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="message" 
                                      ...
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                      placeholder="Décrivez votre projet, vos attentes ou posez vos questions..."><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\HorizonImmo\resources\views\client\applications\create.blade.php ENDPATH**/ ?>