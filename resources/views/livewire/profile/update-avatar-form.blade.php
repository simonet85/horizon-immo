            ...
            <div class="flex-1">
                ...
                @if($avatar)
                    ...
                    <p class="text-xs text-gray-500">
                        Fichier : {{ $avatar->getClientOriginalName() }} ({{ number_format($avatar->getSize() / 1024, 1) }} KB)
                    </p>
                @else
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <div class="text-xs text-green-600 space-y-1">
                                    <p><strong>Fichier :</strong> {{ $avatar->getClientOriginalName() }}</p>
                                    <p><strong>Taille :</strong> {{ number_format($avatar->getSize() / 1024, 1) }} KB</p>
                                    <p><strong>Type :</strong> {{ strtoupper(pathinfo($avatar->getClientOriginalName(), PATHINFO_EXTENSION)) }}</p>
                                </div>
                            </div>
                            <button type="button" 
