            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        @foreach(array_slice($property->images, 1) as $image)
                            <img src="{{ $image }}" alt="{{ $property->title }}" class="w-full h-48 object-cover rounded-lg hover:scale-105 transition-transform duration-200 cursor-pointer">
                        @endforeach
                    </div>
                </div>
                @endif
