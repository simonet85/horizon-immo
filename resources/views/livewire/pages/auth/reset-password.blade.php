...
<div class="animate-fade-in">
    ...
    <form wire:submit="resetPassword" class="space-y-6">
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="email" 
                    name="email"
                    class="block w-full pl-12 pr-4 py-4 border {{ $errors->get('email') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white' }} rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200" 
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="password" 
                    name="password"
                    class="block w-full pl-12 pr-12 py-4 border {{ $errors->get('password') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white' }} rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200" 
                    placeholder="••••••••••••"
                    required 
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    class="block w-full pl-12 pr-12 py-4 border {{ $errors->get('password_confirmation') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white' }} rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200" 
                    placeholder="••••••••••••"
                    required 
                    autocomplete="new-password" 
                />
        ...
        <div class="text-center pt-4">
            <a href="{{ route('login') }}" wire:navigate class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 transition-colors">
