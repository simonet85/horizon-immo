    ...
    @if (session('status'))
        <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl animate-fade-in">
            <div class="flex items-center">
                ...
                <p class="ml-3 text-sm font-medium">{{ session('status') }}</p>
            </div>
        </div>
    @endif
        ...
        <div class="group">
            ...
            <div class="relative">
                ...
                <input 
                    ...
                    type="email" 
                    name="email"
                    class="block w-full pl-12 pr-4 py-4 border {{ $errors->get('email') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white' }} rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200" 
