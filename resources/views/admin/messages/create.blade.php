...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.messages.store') }}" method="POST" class="space-y-6 p-6">
                    @csrf
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select name="property_id" 
                                                id="property_id" 
                                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('property_id') border-red-300 @enderror">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <textarea name="message" 
                                                  id="message" 
                                                  rows="6" 
                                                  class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('message') border-red-300 @enderror">{{ old('message') }}</textarea>
                                        @error('message')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
