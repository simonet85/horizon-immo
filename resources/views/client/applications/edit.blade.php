...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <a href="{{ route('client.applications.show', $application) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                ← Retour aux détails
            </a>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <form action="{{ route('client.applications.update', $application) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('country_residence', $application->country_residence) }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   id="desired_city" 
                                   name="desired_city" 
                                   value="{{ old('desired_city', $application->desired_city) }}"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
                            @error('desired_city')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <select id="property_type" 
                                ...
                                <option value="Villa" {{ old('property_type', $application->property_type) == 'Villa' ? 'selected' : '' }}>Villa</option>
                                <option value="Studio" {{ old('property_type', $application->property_type) == 'Studio' ? 'selected' : '' }}>Studio</option>
                                <option value="Loft" {{ old('property_type', $application->property_type) == 'Loft' ? 'selected' : '' }}>Loft</option>
                                <option value="Duplex" {{ old('property_type', $application->property_type) == 'Duplex' ? 'selected' : '' }}>Duplex</option>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('personal_contribution_percentage', $application->personal_contribution_percentage) }}"
                                   min="0" 
                                   max="100"
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                   required>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="additional_info" 
                                      ...
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                      placeholder="Ajoutez toute information que vous jugez utile pour votre projet...">{{ old('additional_info', $application->additional_info) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="message" 
                                      ...
                                      rows="4" 
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                      placeholder="Décrivez votre projet, vos attentes ou posez vos questions...">{{ old('message', $application->message) }}</textarea>
                            @error('message')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
