    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                <div class="p-6 text-gray-900">
                        ...
                        <div class="bg-blue-50 p-6 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $propertyMessages->count() }} message(s)</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 p-6 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $contactMessages->count() }} message(s)</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-yellow-50 p-6 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $propertyMessages->whereNotNull('admin_response')->count() + $contactMessages->whereNotNull('admin_response')->count() }} réponse(s)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="flex-1">
                                                ...
                                                @if($message->property)
                                                    <p class="text-sm text-gray-600 mb-2">
                                                        <strong>Propriété:</strong> {{ $message->property->title }}
                                                    </p>
                                                @endif
                                                <p class="text-gray-600 mb-2">{{ Str::limit($message->message, 100) }}</p>
                                ...
                                @foreach($contactMessages as $contactMessage)
                                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                        <div class="flex justify-between items-start">
                                            <div class="flex-1">
                                                <div class="flex items-center mb-2">
                                                    <h4 class="font-semibold text-gray-800">{{ $contactMessage->subject }}</h4>
                                                ...
                                                <p class="text-gray-600 mb-2">{{ Str::limit($contactMessage->message, 100) }}</p>
                                                <p class="text-sm text-gray-500">{{ $contactMessage->created_at->format('d/m/Y à H:i') }}</p>
                                            </div>
                                            <div class="ml-4">
                                                <a href="{{ route('client.contact-messages.show', $contactMessage) }}" 
                                                   class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue active:bg-blue-700 transition ease-in-out duration-150">
                                                    Voir
                                                </a>
                                            </div>
                    ...
                    @if($propertyMessages->count() === 0 && $contactMessages->count() === 0)
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('contact') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Nous contacter
                                </a>
                            </div>
                        </div>
